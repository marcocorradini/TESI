function [theta1P,theta2P,theta1A,theta2A,O,C1,C2,P1,A1] = get_theta(P,A,param);
    ...
    P1=[a1*cos(theta1P)+a2*cos(theta1P+theta2P);a1*sin(theta1P)+a2*sin(theta1P+theta2P)];   % punto A per verifica
    A1=[a1*cos(theta1A)+a2*cos(theta1A+theta2A);a1*sin(theta1A)+a2*sin(theta1A+theta2A)];   % punto B per verifica
end